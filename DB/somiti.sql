...
-- Dumping data for table somiti.member_info: ~1 rows (approximately)
/*!40000 ALTER TABLE `member_info` DISABLE KEYS */;
INSERT INTO `member_info` (`member_id`, `member_name`, `phone_no`, `email`, `present_address`, `permanent_address`, `gender`, `joining_date`) VALUES
	(1, 'ssss', '123333', 'wee@ddd.com', 'sdfdsfd', 'sdfdsf', 'Male', NULL);
