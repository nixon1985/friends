...
-- Dumping data for table somiti.member_info: ~8 rows (approximately)
/*!40000 ALTER TABLE `member_info` DISABLE KEYS */;
INSERT INTO `member_info` (`member_id`, `member_no`, `member_name`, `phone_no`, `email`, `present_address`, `permanent_address`, `gender`, `joining_date`, `monthly_payable`, `opening_balance`, `photo_path`) VALUES
	(27, 1001, 'sdfdffdsf s', '324324234', 'Male', 'DDDDD', 'RRRRRR', NULL, NULL, NULL, 0.00, '0'),
	(28, 1002, 'dssdfsdf', 'sdfdfsdf', '', 'sdfsdf', 'sdfsdfsdfsdf', 'Male', NULL, NULL, 0.00, 'uploads/1002.png'),
	(29, 1003, 'adasdad', '', '', '', '', 'Male', NULL, NULL, 0.00, '0'),
	(30, 1004, 'sdfsfdsf', '', '', '', '', 'Male', NULL, NULL, 0.00, '0'),
	(31, 1005, 'fdsfsfdsf', '', '', '', '', 'Male', NULL, NULL, 0.00, '0'),
	(32, 1006, 'dsfsdfsf', '', '', '', '', 'Male', NULL, NULL, 0.00, '0'),
	(33, 1007, 'sfsdf', '', '', '', '', 'Male', NULL, NULL, 0.00, '0'),
	(34, 1008, '44444', '', '', '', '', 'Male', NULL, NULL, 0.00, '0'),
	(35, 1009, 'wrwrwer', '', '', '', '', 'Male', NULL, NULL, 0.00, '0');
